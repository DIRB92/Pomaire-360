...
const LANGS = {
  es: {
    ...
    nav_weather:"Clima", nav_tour:"Recorrido", nav_gallery:"Galería", nav_events:"Eventos", nav_reviews:"Reseñas",
  ...
  en: {
    ...
    nav_weather:"Weather", nav_tour:"Tour", nav_gallery:"Gallery", nav_events:"Events", nav_reviews:"Reviews",
  ...
  pt: {
    ...
    nav_weather:"Clima", nav_tour:"Roteiro", nav_gallery:"Galeria", nav_events:"Eventos", nav_reviews:"Avaliações",
  ...
  fr: {
    ...
    nav_weather:"Météo", nav_tour:"Itinéraire", nav_gallery:"Galerie", nav_events:"Événements", nav_reviews:"Avis",
  ...
  ru: {
    ...
    nav_weather:"Погода", nav_tour:"Маршрут", nav_gallery:"Галерея", nav_events:"События", nav_reviews:"Отзывы",
  ...
  ja: {
    ...
    nav_weather:"天気", nav_tour:"観光ルート", nav_gallery:"ギャラリー", nav_events:"イベント", nav_reviews:"レビュー",
  ...
  zh: {
    ...
    nav_weather:"天气", nav_tour:"行程", nav_gallery:"画廊", nav_events:"活动", nav_reviews:"评价",
...
const LANG_EXTRA = {
  es: {
    ...
    ga4_badge:"Dónde comer", ga4_title:"Restaurantes y fondas", ga4_detail:"Numerosos restaurantes en la calle principal y sus laterales. Los fines de semana pueden tener espera. Se recomienda llegar antes del mediodía.", ga4_link:"📍 Buscar restaurantes",
  ...
  en: {
    ...
    ga4_badge:"Where to eat", ga4_title:"Restaurants and eateries", ga4_detail:"Numerous restaurants on the main street and its side streets. On weekends there may be a wait. We recommend arriving before noon.", ga4_link:"📍 Find restaurants",
  ...
  pt: {
    ...
    ga4_badge:"Onde comer", ga4_title:"Restaurantes e fondas", ga4_detail:"Numerosos restaurantes na rua principal e nas laterais. Nos fins de semana pode haver espera. Recomenda-se chegar antes do meio-dia.", ga4_link:"📍 Buscar restaurantes",
  ...
  fr: {
    ...
    ga4_badge:"Où manger", ga4_title:"Restaurants et auberges", ga4_detail:"De nombreux restaurants sur la rue principale et ses rues adjacentes. Le week-end il peut y avoir de l'attente. Il est conseillé d'arriver avant midi.", ga4_link:"📍 Chercher des restaurants",
  ...
  ru: {
    ...
    ga4_badge:"Где поесть", ga4_title:"Рестораны и закусочные", ga4_detail:"Множество ресторанов на главной улице и в переулках. В выходные возможно ожидание. Рекомендуем приходить до полудня.", ga4_link:"📍 Найти рестораны",
