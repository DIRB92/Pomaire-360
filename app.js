...
const LANGS = {
  ...
  ja: {
    ...
    hero_tag:"📍 ポマイレ · メリピージャ · 首都圏",
    hero_h1:"<em>ポマイレ</em>へようこそ",
    hero_sub:"チリで最も有名な陶芸の村を訪れる方、または新たに住み始めた方に必要な情報をすべてご案内します。サービス、緊急連絡先、駐車場など。",
    cta_plan:"訪問を計画する", cta_directions:"アクセス方法", cta_eat:"食事はこちら",
    wa_text:"シェア", wa_aria:"Pomaire 360 をWhatsAppでシェア",
    wa_share:"チリで最も有名な陶芸の村ポマイレを発見しよう！🏺 サービス・グルメ・観光の完全ガイド：https://www.pomaire360.cl/",
    ...
    footer_date:"最終更新：2026年6月 · ポマイレ、メリピージャ、首都圏",
    ...
    tour_5_title:"伝統料理の昼食", tour_5_desc:"陶器で提供される牛肉のカスエラや巨大エンパナーダをお楽しみください。",
