...
const LANGS = {
  ...
  en: {
    ...
    wa_share:"Discover Pomaire, Chile's most famous pottery village! 🏺 Complete guide to services, food and tourism: https://www.pomaire360.cl/",
  ...
  pt: {
    ...
    wa_share:"Descubra Pomaire, a vila de cerâmica mais famosa do Chile! 🏺 Guia completo de serviços, gastronomia e turismo: https://www.pomaire360.cl/",
  ...
  fr: {
    ...
    wa_share:"Découvrez Pomaire, le village de poterie le plus célèbre du Chili ! 🏺 Guide complet des services, de la gastronomie et du tourisme : https://www.pomaire360.cl/",
  ...
  ru: {
    ...
    wa_share:"Откройте для себя Помайре — самую известную гончарную деревню Чили! 🏺 Полный гид по услугам, кухне и туризму: https://www.pomaire360.cl/",
  ...
  ja: {
    ...
    nav_map:"地図", nav_donate:"サポート", nav_tagline:"観光と文化",
    ...
    wa_share:"チレで最も有名な陶芸の村ポマイレを発見しよう！🏺 サービス・グルメ・観光の完全ガイド：https://www.pomaire360.cl/",
  ...
  zh: {
    ...
    nav_map:"地图", nav_donate:"支持", nav_tagline:"旅游与文化",
    ...
    wa_share:"探索智利最著名的陶艺村波迈雷！🏺 服务、美食与旅游完整指南：https://www.pomaire360.cl/",
...
const PLACES = [
  ...
  { id:'sv3', cat:'services', icon:'💲', lat:-33.65029994302147, lng:-71.1496768882763, name:'Cajero Automático (ATM)', desc:'Banco de Chile · Roberto Bravo 445', addr:'Roberto Bravo 445, Pomaire', gmap:'https://maps.app.goo.gl/HcGUyYo8DQq94NBj9', markerColor:'#0033A0' },
  ...
  { id:'sv9', cat:'services', icon:'🧵', lat:-33.64808726960897, lng:-71.14915833045953, name:'Taller de costura J.E.M.E "Dándole vida a tu Ropa"', desc:'Costura y arreglos de ropa · General Baquedano 241', addr:'Gral. Baquedano 241, Pomaire, Melipilla, Región Metropolitana', gmap:'https://maps.app.goo.gl/MeYgE8ftdphq19rt6', phone:'+56 9 5582 2650', wsp:'56955822650' },
  // ── POTTERY ──
  ...
  { id:'po7', cat:'pottery', icon:'🪴', lat:-33.646642321720606, lng:-71.15017194940056, name:'Fábrica de maceteros y vasijas de greda Don Petro', desc:'Maceteros y vasijas de greda · Calle El Carmen', addr:'El Carmen, Pomaire', gmap:'https://maps.app.goo.gl/R2Zgnzcvm3sWY7H4A' },
  // ── FOOD ──
...
function initMap() {
  ...
  PLACES.forEach(p => {
    ...
    const bg = p.markerColor ? p.markerColor : (featured ? '#E6B246' : '#B85C2C');
