/* ═══════════════════════════════════════════════════════════════════════════
   langs.js — Diccionarios de traducción multiidioma para Pomaire 360
   Extraído de app.js para reducir el tamaño del script principal y
   permitir carga independiente / caching separado.
...
Object.assign(LANGS, {
  es: {
    ...
    bio_title:"Biografías de Alfareros", bio_sub:"Las historias de vida de los maestros y maestras de la greda de Pomaire · <em>Potter biographies</em>",
    bio_intro:"Detrás de cada pieza de greda hay una vida dedicada al oficio. Aquí reunimos las <strong>historias de los alfareros y alfareras de Pomaire</strong>, los maestros que mantienen viva una tradición centenaria. ¿Conoces a un alfarero cuya historia merece ser contada? Compártela con la comunidad: cada biografía se revisa antes de publicarse.",
    bio_search_ph:"Buscar alfarero…", bio_add_btn:"Compartir una historia",
    bio_loading:"Cargando biografías…", bio_empty:"Aún no hay biografías publicadas. Sé el primero en compartir la historia de un alfarero.", bio_empty_search:"No se encontraron alfareros con ese nombre.", bio_error:"No se pudieron cargar las biografías. Intenta más tarde.",
    bio_more:"Leer más ▾", bio_less:"Leer menos ▴", bio_by:"aportado por", bio_wa:"WhatsApp", bio_copied:"Contacto copiado",
    bio_sent:"¡Biografía enviada! Se publicará tras revisión.", bio_err_required:"Completa al menos el nombre y la biografía.", bio_err_short:"La biografía es muy corta. Cuéntanos un poco más (mínimo 40 caracteres).",
    bio_err_img_big:"Imagen muy pesada. Máximo 4 MB.", bio_err_img_type:"Solo JPEG, PNG, WebP o GIF.", bio_err_img_upload:"No se pudo subir la imagen.",
    bio_modal_title:"Comparte la historia de un alfarero", bio_modal_sub:"Cuéntanos sobre un maestro o maestra de la greda de Pomaire. Tu aporte se revisa antes de publicarse.",
    bio_f_nombre:"Nombre del alfarero/a", bio_f_oficio:"Oficio o especialidad (opcional)", bio_f_exp:"Años de oficio (opcional)", bio_f_bio:"Biografía", bio_f_contacto:"Contacto (opcional)", bio_f_foto:"Foto del alfarero/a (opcional · máx 4 MB)", bio_f_foto_ph:"Toca para elegir una foto", bio_f_autor:"Tu nombre",
    bio_cancel:"Cancelar", bio_submit:"Enviar biografía", bio_submitting:"Enviando…",
    ...
    footer_plan:"Planifica tu visita",
  ...
  en: {
    ...
    bio_title:"Potter Biographies", bio_sub:"The life stories of Pomaire's master clay artisans · <em>Biografías de alfareros</em>",
    bio_intro:"Behind every piece of clay there is a life devoted to the craft. Here we gather the <strong>stories of Pomaire's potters</strong>, the masters who keep a centuries-old tradition alive. Do you know a potter whose story deserves to be told? Share it with the community — every biography is reviewed before being published.",
    bio_search_ph:"Search a potter…", bio_add_btn:"Share a story",
    bio_loading:"Loading biographies…", bio_empty:"No biographies published yet. Be the first to share a potter's story.", bio_empty_search:"No potters found with that name.", bio_error:"Couldn't load the biographies. Please try again later.",
    bio_more:"Read more ▾", bio_less:"Read less ▴", bio_by:"contributed by", bio_wa:"WhatsApp", bio_copied:"Contact copied",
    bio_sent:"Biography sent! It will be published after review.", bio_err_required:"Please enter at least the name and the biography.", bio_err_short:"The biography is too short. Tell us a bit more (at least 40 characters).",
    bio_err_img_big:"Image too large. Maximum 4 MB.", bio_err_img_type:"Only JPEG, PNG, WebP or GIF.", bio_err_img_upload:"The image could not be uploaded.",
    bio_modal_title:"Share a potter's story", bio_modal_sub:"Tell us about a master clay artisan from Pomaire. Your contribution is reviewed before publishing.",
    bio_f_nombre:"Potter's name", bio_f_oficio:"Craft or specialty (optional)", bio_f_exp:"Years of craft (optional)", bio_f_bio:"Biography", bio_f_contacto:"Contact (optional)", bio_f_foto:"Potter's photo (optional · max 4 MB)", bio_f_foto_ph:"Tap to choose a photo", bio_f_autor:"Your name",
    bio_cancel:"Cancel", bio_submit:"Send biography", bio_submitting:"Sending…",
    ...
    cta_plan:"Plan your visit", cta_directions:"How to get there", cta_eat:"Business Directory",
    ...
    // 2026 redesign keys
    chapter_explore:"Chapter 1 — Explore the village",
    chapter_plan:"Chapter 2 — Plan your route",
    chapter_prepare:"Chapter 3 — Prepare for the trip",
    chapter_remember:"Chapter 4 — Take a souvenir",
    chapter_comeback:"Chapter 5 — Plan your return",
    hero_scroll:"Discover",
    nav_map_full:"Tourist Map",
    nav_g_essentials:"Essentials",
    nav_g_todo:"What to do",
    nav_g_eatsleep:"Eat & Sleep",
    nav_g_plan:"Plan",
    footer_explore:"Explore",
    footer_plan:"Plan your visit",
    footer_services:"Services",
    footer_merchants:"For merchants",
    footer_community:"Community",
    gf_cta:"Play!",
    an_cta:"Add your business",
    fpb_tag:"💎 Must-see",
    fpb_text:"The world's <strong>largest clay piggy bank</strong>",
    fpb_cta:"Discover it →",
    map_full_cta:"Open full Tourist Map",
    map_full_cta_note:"Expanded view with legend, map styles, share locations and more",
    search_empty:"No results found",
    search_placeholder:"Search in Pomaire 360...",
    gal_7:"Giant clay piggy bank",
    gal_8:"Entrance to Pomaire",
    gal_9:"Artisan street",
    gal_10:"Historic Pomaire",
    gal_11:"Valley at sunset",
    gal_12:"Clay piggy pots",
    gal_13:"Traditional clay figures",
    filter_lodging:"Sleep",
    filter_highlight:"Highlights",
    ev_m1:"JAN–FEB", ev_m2:"JUN", ev_m3:"SEP", ev_m4:"NOV–DEC"
  },
  pt: {
    ...
    bio_title:"Biografias de Oleiros", bio_sub:"As histórias de vida dos mestres e mestras do barro de Pomaire · <em>Potter biographies</em>",
    bio_intro:"Por trás de cada peça de barro há uma vida dedicada ao ofício. Aqui reunimos as <strong>histórias dos oleiros e oleiras de Pomaire</strong>, os mestres que mantêm viva uma tradição centenária. Você conhece um oleiro cuja história merece ser contada? Compartilhe com a comunidade — cada biografia é revisada antes de ser publicada.",
    bio_search_ph:"Buscar oleiro…", bio_add_btn:"Compartilhar uma história",
    bio_loading:"Carregando biografias…", bio_empty:"Ainda não há biografias publicadas. Seja o primeiro a compartilhar a história de um oleiro.", bio_empty_search:"Nenhum oleiro encontrado com esse nome.", bio_error:"Não foi possível carregar as biografias. Tente mais tarde.",
    bio_more:"Ler mais ▾", bio_less:"Ler menos ▴", bio_by:"contribuído por", bio_wa:"WhatsApp", bio_copied:"Contato copiado",
    bio_sent:"Biografia enviada! Será publicada após revisão.", bio_err_required:"Preencha ao menos o nome e a biografia.", bio_err_short:"A biografia é muito curta. Conte-nos um pouco mais (mínimo 40 caracteres).",
    bio_err_img_big:"Imagem muito grande. Máximo 4 MB.", bio_err_img_type:"Apenas JPEG, PNG, WebP ou GIF.", bio_err_img_upload:"Não foi possível enviar a imagem.",
    bio_modal_title:"Compartilhe a história de um oleiro", bio_modal_sub:"Conte-nos sobre um mestre do barro de Pomaire. Sua contribuição é revisada antes da publicação.",
    bio_f_nombre:"Nome do oleiro/a", bio_f_oficio:"Ofício ou especialidade (opcional)", bio_f_exp:"Anos de ofício (opcional)", bio_f_bio:"Biografia", bio_f_contacto:"Contato (opcional)", bio_f_foto:"Foto do oleiro/a (opcional · máx 4 MB)", bio_f_foto_ph:"Toque para escolher uma foto", bio_f_autor:"Seu nome",
    bio_cancel:"Cancelar", bio_submit:"Enviar biografia", bio_submitting:"Enviando…",
    ...
    cta_plan:"Planeje sua visita", cta_directions:"Como chegar", cta_eat:"Diretório de Negócios",
    ...
    // 2026 redesign keys
    chapter_explore:"Capítulo 1 — Explore a vila",
    chapter_plan:"Capítulo 2 — Planeje sua rota",
    chapter_prepare:"Capítulo 3 — Prepare-se para a viagem",
    chapter_remember:"Capítulo 4 — Leve uma lembrança",
    chapter_comeback:"Capítulo 5 — Planeje seu retorno",
    hero_scroll:"Descubra",
    nav_map_full:"Mapa Turístico",
    nav_g_essentials:"Essenciais",
    nav_g_todo:"O que fazer",
    nav_g_eatsleep:"Comer e dormir",
    nav_g_plan:"Planeje",
    footer_explore:"Explorar",
    footer_plan:"Planeje sua visita",
    footer_services:"Serviços",
    footer_merchants:"Para comerciantes",
    footer_community:"Comunidade",
    gf_cta:"Jogue!",
    an_cta:"Adicione seu negócio",
    fpb_tag:"💎 Imperdível",
    fpb_text:"O porquinho cofre de barro <strong>maior do mundo</strong>",
    fpb_cta:"Conheça →",
    map_full_cta:"Abrir Mapa Turístico completo",
    map_full_cta_note:"Vista ampliada com legenda, estilos de mapa, compartilhar locais e mais",
    search_empty:"Nenhum resultado encontrado",
    search_placeholder:"Buscar em Pomaire 360...",
    gal_7:"Porquinho cofre gigante",
    gal_8:"Entrada de Pomaire",
    gal_9:"Rua do artesanato",
    gal_10:"Pomaire histórico",
    gal_11:"Vale ao entardecer",
    gal_12:"Panelas porquinho de barro",
    gal_13:"Figuras tradicionais de barro",
    filter_lodging:"Dormir",
    filter_highlight:"O que ver",
    ev_m1:"JAN–FEV", ev_m2:"JUN", ev_m3:"SET", ev_m4:"NOV–DEZ"
  },
  fr: {
    ...
    bio_title:"Biographies de potiers", bio_sub:"Les histoires de vie des maîtres potiers de l'argile de Pomaire · <em>Potter biographies</em>",
    bio_intro:"Derrière chaque pièce d'argile se cache une vie consacrée au métier. Nous réunissons ici les <strong>histoires des potiers et potières de Pomaire</strong>, les maîtres qui perpétuent une tradition séculaire. Connaissez-vous un potier dont l'histoire mérite d'être racontée ? Partagez-la avec la communauté — chaque biographie est vérifiée avant sa publication.",
    bio_search_ph:"Rechercher un potier…", bio_add_btn:"Partager une histoire",
    bio_loading:"Chargement des biographies…", bio_empty:"Aucune biographie publiée pour l'instant. Soyez le premier à partager l'histoire d'un potier.", bio_empty_search:"Aucun potier trouvé avec ce nom.", bio_error:"Impossible de charger les biographies. Réessayez plus tard.",
    bio_more:"Lire plus ▾", bio_less:"Lire moins ▴", bio_by:"proposé par", bio_wa:"WhatsApp", bio_copied:"Contact copié",
    bio_sent:"Biographie envoyée ! Elle sera publiée après vérification.", bio_err_required:"Indiquez au moins le nom et la biographie.", bio_err_short:"La biographie est trop courte. Dites-nous en un peu plus (au moins 40 caractères).",
    bio_err_img_big:"Image trop lourde. Maximum 4 Mo.", bio_err_img_type:"Uniquement JPEG, PNG, WebP ou GIF.", bio_err_img_upload:"Impossible d'envoyer l'image.",
    bio_modal_title:"Partagez l'histoire d'un potier", bio_modal_sub:"Parlez-nous d'un maître potier de Pomaire. Votre contribution est vérifiée avant publication.",
    bio_f_nombre:"Nom du potier/de la potière", bio_f_oficio:"Métier ou spécialité (facultatif)", bio_f_exp:"Années de métier (facultatif)", bio_f_bio:"Biographie", bio_f_contacto:"Contact (facultatif)", bio_f_foto:"Photo du potier (facultatif · max 4 Mo)", bio_f_foto_ph:"Touchez pour choisir une photo", bio_f_autor:"Votre nom",
    bio_cancel:"Annuler", bio_submit:"Envoyer la biographie", bio_submitting:"Envoi…",
    ...
    cta_plan:"Planifiez votre visite", cta_directions:"Comment venir", cta_eat:"Répertoire de commerces",
    ...
    chapter_explore:"Chapitre 1 — Explorez le village",
    chapter_plan:"Chapitre 2 — Planifiez votre parcours",
    chapter_prepare:"Chapitre 3 — Préparez votre visite",
    chapter_remember:"Chapitre 4 — Ramenez un souvenir",
    chapter_comeback:"Chapitre 5 — Planifiez votre retour",
    hero_scroll:"Découvrez",
    nav_map_full:"Plan Touristique",
    nav_g_essentials:"Essentiels",nav_g_todo:"À faire",nav_g_eatsleep:"Manger & Dormir",nav_g_plan:"Planifier",
    footer_explore:"Explorer",footer_services:"Services",footer_merchants:"Pour commerçants",footer_community:"Communauté",
    gf_cta:"Jouez!",an_cta:"Ajoutez votre commerce",
    fpb_tag:"💎 Incontournable",fpb_text:"La tirelire en argile <strong>la plus grande du monde</strong>",fpb_cta:"Découvrir →",
    map_full_cta:"Ouvrir le Plan Touristique complet",map_full_cta_note:"Vue élargie avec légende, styles de carte et partage de lieux",
    search_empty:"Aucun résultat",search_placeholder:"Rechercher dans Pomaire 360...",
    gal_7:"Tirelire géante",gal_8:"Entrée de Pomaire",gal_9:"Rue de l'artisanat",gal_10:"Pomaire historique",gal_11:"Vallée au coucher du soleil",gal_12:"Pots cochon en argile",gal_13:"Figures en argile traditionnelles",
    filter_lodging:"Dormir",filter_highlight:"À voir",
    ev_m1:"JAN–FÉV",ev_m2:"JUIN",ev_m3:"SEPT",ev_m4:"NOV–DÉC"
  },
  ru: {
    ...
    bio_title:"Биографии гончаров", bio_sub:"Истории жизни мастеров глины Помайре · <em>Potter biographies</em>",
    bio_intro:"За каждым изделием из глины стоит жизнь, посвящённая ремеслу. Здесь мы собираем <strong>истории гончаров Помайре</strong> — мастеров, которые хранят вековую традицию. Знаете гончара, чья история достойна рассказа? Поделитесь ею с сообществом — каждая биография проверяется перед публикацией.",
    bio_search_ph:"Поиск гончара…", bio_add_btn:"Поделиться историей",
    bio_loading:"Загрузка биографий…", bio_empty:"Пока нет опубликованных биографий. Станьте первым, кто расскажет историю гончара.", bio_empty_search:"Гончары с таким именем не найдены.", bio_error:"Не удалось загрузить биографии. Попробуйте позже.",
    bio_more:"Читать далее ▾", bio_less:"Свернуть ▴", bio_by:"добавил(а)", bio_wa:"WhatsApp", bio_copied:"Контакт скопирован",
    bio_sent:"Биография отправлена! Она будет опубликована после проверки.", bio_err_required:"Укажите хотя бы имя и биографию.", bio_err_short:"Биография слишком короткая. Расскажите чуть больше (минимум 40 символов).",
    bio_err_img_big:"Изображение слишком большое. Максимум 4 МБ.", bio_err_img_type:"Только JPEG, PNG, WebP или GIF.", bio_err_img_upload:"Не удалось загрузить изображение.",
    bio_modal_title:"Поделитесь историей гончара", bio_modal_sub:"Расскажите о мастере глины из Помайре. Ваш вклад проверяется перед публикацией.",
    bio_f_nombre:"Имя гончара", bio_f_oficio:"Ремесло или специализация (необязательно)", bio_f_exp:"Годы ремесла (необязательно)", bio_f_bio:"Биография", bio_f_contacto:"Контакт (необязательно)", bio_f_foto:"Фото гончара (необязательно · макс. 4 МБ)", bio_f_foto_ph:"Нажмите, чтобы выбрать фото", bio_f_autor:"Ваше имя",
    bio_cancel:"Отмена", bio_submit:"Отправить биографию", bio_submitting:"Отправка…",
    ...
    cta_plan:"Спланируйте визит", cta_directions:"Как добраться", cta_eat:"Каталог бизнесов",
    ...
    chapter_explore:"Глава 1 — Исследуйте деревню",
    chapter_plan:"Глава 2 — Спланируйте маршрут",
    chapter_prepare:"Глава 3 — Подготовьтесь к поездке",
    chapter_remember:"Глава 4 — Возьмите сувенир",
    chapter_comeback:"Глава 5 — Спланируйте возвращение",
    hero_scroll:"Откройте",
    nav_map_full:"Туристическая карта",
    nav_g_essentials:"Основное",nav_g_todo:"Что делать",nav_g_eatsleep:"Еда и сон",nav_g_plan:"Планирование",
    footer_explore:"Исследовать",footer_services:"Услуги",footer_merchants:"Для торговцев",footer_community:"Сообщество",
    gf_cta:"Играть!",an_cta:"Добавить ваш бизнес",
    fpb_tag:"💎 Обязательно",fpb_text:"Самая <strong>большая глиняная копилка</strong> в мире",fpb_cta:"Узнать →",
    map_full_cta:"Открыть полную карту",map_full_cta_note:"Расширенный вид с легендой, стилями карты и обменом местами",
    search_empty:"Результатов не найдено",search_placeholder:"Поиск в Pomaire 360...",
    gal_7:"Гигантская копилка",gal_8:"Вход в Помаире",gal_9:"Ремесленная улица",gal_10:"Историческое Помаире",gal_11:"Долина на закате",gal_12:"Глиняные горшки-свинки",gal_13:"Традиционные глиняные фигуры",
    filter_lodging:"Ночлег",filter_highlight:"Достопримечательности",
    ev_m1:"ЯНВ–ФЕВ",ev_m2:"ИЮНЬ",ev_m3:"СЕНТ",ev_m4:"НОЯ–ДЕК"
  },
  ja: {
    nav_park:"駐車場", nav_health:"医療", nav_security:"安全", nav_commerce:"サービス",
    nav_pottery:"陶芸", nav_food:"グルメ", nav_around:"周辺", nav_shops_g:"商店", nav_plaza:"広場", nav_bios:"陶工の物語",
    bio_title:"陶工の物語", bio_sub:"ポマイレの粘土細工の名匠たちの人生の物語 · <em>Potter biographies</em>",
    bio_intro:"一つひとつの粘土細工の背後には、職人としての人生があります。ここでは、何世紀も続く伝統を守り続ける<strong>ポマイレの陶工たちの物語</strong>を集めています。語り継ぐ価値のある陶工をご存じですか？コミュニティで共有してください。すべての物語は公開前に確認されます。",
    bio_search_ph:"陶工を検索…", bio_add_btn:"物語を共有する",
    bio_loading:"物語を読み込み中…", bio_empty:"まだ公開された物語はありません。最初に陶工の物語を共有しましょう。", bio_empty_search:"その名前の陶工は見つかりませんでした。", bio_error:"物語を読み込めませんでした。後でもう一度お試しください。",
    bio_more:"続きを読む ▾", bio_less:"閉じる ▴", bio_by:"投稿者", bio_wa:"WhatsApp", bio_copied:"連絡先をコピーしました",
    bio_sent:"物語を送信しました！確認後に公開されます。", bio_err_required:"少なくとも名前と物語を入力してください。", bio_err_short:"物語が短すぎます。もう少し詳しく教えてください（40文字以上）。",
    bio_err_img_big:"画像が大きすぎます。最大4MBです。", bio_err_img_type:"JPEG、PNG、WebP、GIFのみです。", bio_err_img_upload:"画像をアップロードできませんでした。",
    bio_modal_title:"陶工の物語を共有する", bio_modal_sub:"ポマイレの粘土細工の名匠について教えてください。投稿は公開前に確認されます。",
    bio_f_nombre:"陶工の名前", bio_f_oficio:"職業・専門（任意）", bio_f_exp:"経験年数（任意）", bio_f_bio:"物語", bio_f_contacto:"連絡先（任意）", bio_f_foto:"陶工の写真（任意・最大4MB）", bio_f_foto_ph:"タップして写真を選択", bio_f_autor:"あなたの名前",
    bio_cancel:"キャンセル", bio_submit:"物語を送信", bio_submitting:"送信中…",
    ...
    route_clear:"ルートを消去",
    chapter_explore:"第1章 — 村を探索",
    chapter_plan:"第2章 — ルートを計画",
    chapter_prepare:"第3章 — 旅の準備",
    chapter_remember:"第4章 — お土産を持ち帰る",
    chapter_comeback:"第5章 — 再訪を計画",
    hero_scroll:"発見する",
    nav_map_full:"観光マップ",
    nav_g_essentials:"基本情報",nav_g_todo:"アクティビティ",nav_g_eatsleep:"食事と宿泊",nav_g_plan:"計画する",
    footer_explore:"探索",footer_plan:"訪問を計画",footer_services:"サービス",footer_merchants:"商人向け",footer_community:"コミュニティ",
    gf_cta:"遊ぶ！",an_cta:"ビジネスを追加",
    fpb_tag:"💎 必見",fpb_text:"世界<strong>最大の粘土貯金箱</strong>",fpb_cta:"詳しく →",
    map_full_cta:"観光マップを開く",map_full_cta_note:"凡例、マップスタイル、場所の共有機能付き拡大表示",
    search_empty:"結果なし",search_placeholder:"Pomaire 360で検索...",
    gal_7:"巨大貯金箱",gal_8:"ポマイレ入口",gal_9:"工芸品通り",gal_10:"歴史的ポマイレ",gal_11:"夕暮れの谷",gal_12:"ブタの粘土鍋",gal_13:"伝統的な粘土の置物",
    filter_lodging:"宿泊",filter_highlight:"見どころ",
  ...
  zh: {
    ...
    route_clear:"清除路线",
    chapter_explore:"第一章 — 探索村庄",
    chapter_plan:"第二章 — 规划路线",
    chapter_prepare:"第三章 — 准备出行",
    chapter_remember:"第四章 — 带走纪念品",
    chapter_comeback:"第五章 — 规划再访",
    hero_scroll:"探索",
    nav_map_full:"旅游地图",
    nav_g_essentials:"基本信息",nav_g_todo:"活动",nav_g_eatsleep:"餐饮住宿",nav_g_plan:"规划",
    footer_explore:"探索",footer_services:"服务",footer_merchants:"商户专区",footer_community:"社区",
    gf_cta:"玩游戏！",an_cta:"添加您的商铺",
    fpb_tag:"💎 必看",fpb_text:"世界<strong>最大的陶土储蓄罐</strong>",fpb_cta:"了解详情 →",
    map_full_cta:"打开完整旅游地图",map_full_cta_note:"带图例、地图样式和位置共享的扩展视图",
    search_empty:"未找到结果",search_placeholder:"在Pomaire 360中搜索...",
    gal_7:"巨型陶土储蓄罐",gal_8:"波马伊雷入口",gal_9:"手工艺街",gal_10:"历史波马伊雷",gal_11:"夕阳下的山谷",gal_12:"小猪陶罐",gal_13:"传统陶土摆件",
...
/* ═══════════════════════════════════════════════════════════════════════════
   CLAVES SUPLEMENTARIAS (multiidioma)
   Claves data-t usadas en el HTML de varias subpáginas que no estaban en el
   diccionario base. Se reincorporan aquí (es/en/pt/ja) para que el switcher
...
var SUPPLEMENTAL_I18N = {
  es: {
    ...
    cat_title:"Descubre Pomaire", cat_sub:"Los imperdibles del pueblo alfarero más famoso de Chile", cat_loading:"Cargando categorías...",
    /* navegación / migas comunes */
    nav_games:"Juegos", lnk_intmap:"Ver en mapa interactivo", sub_more:"Más en Pomaire 360", sub_back:"Volver a la guía completa de Pomaire 360",
    /* apoyar */
    apoyar_tag:"💛 Proyecto independiente · Hecho en Pomaire", apoyar_b1_t:"🔄 Siempre actualizado", apoyar_b1_d:"Horarios, contactos y datos revisados constantemente.", apoyar_b2_t:"🚫 Sin publicidad", apoyar_b2_d:"Una guía limpia, sin anuncios ni rastreo.", apoyar_b3_t:"🤝 Apoyo local", apoyar_b3_d:"Damos visibilidad a los artesanos y locales del pueblo.", apoyar_other_t:"Otras formas de apoyar", apoyar_share:"📲 Compartir la guía", apoyar_follow:"📸 Síguenos en Instagram",
    /* el chancho */
    ch_winter_promo:"¡Estaremos abiertos en las vacaciones de invierno! · Lunes a domingo", ch_kicker:"🐷 Atractivo imperdible de Pomaire", ch_h1:"El Chancho alcancía de greda más grande del mundo", ch_author:"Creado por", ch_btn_hist:"Ver Historia", ch_btn_visit:"Cómo Visitar", ch_share:"📤 Compartir", ch_role:"Maestro Alfarero · Pomaire, Chile", ch_bio:"Maestro alfarero pomairino y autor del chancho-alcancía de greda más grande del mundo. Tras un primer chancho en 2010, en 2012 dio forma a una pieza de 1,60 m de alto, 3 m de largo y 550 kilos de greda que hoy es atractivo del pueblo. Con años de oficio trabajando la greda de Pomaire, transformó una idea imposible en una obra única.", ch_howto:"🗺️ Cómo llegar", ch_call:"📞 Llamar", ch_rec_title:"De un sueño a un récord de greda", ch_rec_intro:"La obra que hoy visitan los turistas no nació de un día para otro: fue el resultado de dos intentos, cada uno más ambicioso que el anterior.", ch_rec1_t:"El primer chancho", ch_rec1_d:"En 2010 se creó una alcancía de greda con forma de chancho de <strong>0,4 metros de alto</strong> y <strong>1,55 metros de largo</strong>, con la aspiración de convertirse en récord Guinness por su tamaño. La obra fue presentada a la comunidad pomairina en un paseo de exhibición por la principal arteria turística del pueblo.", ch_rec2_t:"El chancho más grande del mundo", ch_rec2_d:"En 2012, el artesano <strong>César Silva Rojo</strong> fabricó un chancho-alcancía de greda de <strong>1,60 metros de alto por 3 metros de largo</strong> y un peso de <strong>550 kilos</strong>. Esta es la pieza que hoy puede ser visitada por los turistas en su propio taller.", ch_rec2_s1:"<strong>1,60 m</strong> de alto", ch_rec2_s2:"<strong>3 m</strong> de largo", ch_rec2_s3:"<strong>550 kg</strong> de greda", ch_hist_title:"La historia de una idea imposible", ch_s1_t:"La idea", ch_s1_d:"Todo parte de un sueño: crear el chancho-alcancía de greda más grande del mundo, llevando la tradición de Pomaire a una escala nunca vista.", ch_s2_t:"El diseño", ch_s2_d:"Bocetos y cálculos para definir proporciones, estructura y resistencia de una pieza gigante de greda.", ch_s3_t:"El modelado", ch_s3_d:"El trabajo a mano: dar forma a la greda con la técnica heredada de generaciones de alfareros pomairinos.", ch_s4_t:"El secado", ch_s4_d:"Días de paciencia para que la greda pierda humedad lentamente y evitar grietas en una obra de este tamaño.", ch_s5_t:"La cocción", ch_s5_d:"El paso más delicado: el fuego del horno endurece la greda y le da su color terracota definitivo.", ch_s6_t:"La obra terminada", ch_s6_d:"El resultado: el chancho-alcancía de greda más grande del mundo, orgullo de Pomaire y atractivo para sus visitantes.", ch_visit_title:"Cómo visitar", ch_seemap_btn:"📍 Ver en el mapa interactivo", ch_addr:"Dirección: Los Paltos 323, Pomaire, Melipilla", ch_hours:"Horario: Sábado 12:00–18:00 · Domingo 12:00–19:30 · Lunes a Viernes cerrado", ch_phone:"Teléfono: +56 9 3356 6057",
    /* plaza */
    pl2_title:"Iglesia San Antonio de Padua", pl3_title:"Salón del Reino de los Testigos de Jehová",
    /* salud */
    he1_hours:"🕒 Horario: 8:29 a 17:29 hrs",
    /* sugerencias */
    sg_title:"Sugerencias y comentarios", sg_sub:"¿Encontraste un error, tienes una idea o quieres dejar tu comentario? Ayúdanos a mejorar la guía de Pomaire. Tu mensaje llega directo a nuestro correo y WhatsApp.", sg_form_title:"📝 Cuéntanos tu sugerencia", sg_label_name:"Tu nombre", sg_optional:"(opcional)", sg_label_email:"Tu correo", sg_label_type:"Tipo de mensaje", sg_opt_general:"💡 Idea o sugerencia general", sg_opt_place:"📍 Corregir datos de un lugar", sg_opt_business:"🏪 Sumar un negocio o lugar", sg_opt_error:"🐞 Reportar un error del sitio", sg_opt_praise:"💛 Felicitaciones", sg_opt_other:"✉️ Otro", sg_label_msg:"Tu mensaje", sg_alert_msg:"Por favor escribe tu mensaje antes de enviar.", sg_send_wa:"Enviar por WhatsApp", sg_send_mail:"Enviar por correo", sg_note:"🔒 No compartimos tus datos. Usamos tu mensaje solo para responder y mejorar la guía.", sg_b1_t:"👂 Te escuchamos", sg_b1_d:"Cada comentario lo revisa una persona real del proyecto.", sg_b2_t:"🔄 Datos al día", sg_b2_d:"Nos ayudas a corregir horarios, direcciones y contactos.", sg_b3_t:"🤝 Hecho con la comunidad", sg_b3_d:"Pomaire 360 mejora gracias a quienes visitan y viven el pueblo.", sg_ph_name:"Ej: Camila", sg_ph_email:"tucorreo@ejemplo.com", sg_ph_msg:"Escribe aquí tu comentario o sugerencia...",
    eb_kicker:"🎉 Qué está pasando en Pomaire", eb_title:"Próximos eventos y festividades", eb_sub:"Ferias, fiestas y celebraciones del pueblo alfarero. Toca un evento para ver todos los detalles.", eb_go:"Ver detalles →", eb_all:"Ver el calendario completo de eventos →",
    eb_empanada_title:"Concurso de la Mejor Empanada de Pomaire", eb_empanada_teaser:"Horno de barro, jurado popular y las míticas empanadas gigantes. ¡Este sábado, no te lo pierdas!", eb_tag_food:"Evento gastronómico", eb_flag_new:"¡Nuevo!", eb_flag_soon:"🔥 ¡ESTE SÁBADO!", eb_flag_done:"Finalizado", eb_flag_next:"Próxima semana",
    eb_2_teaser:"Procesión, actividades culturales y gastronomía especial en la plaza.", eb_3_teaser:"Fondas, chicha artesanal, cueca y artesanía festiva. ¡La mejor época!", eb_4_teaser:"Nacimientos en greda, adornos y regalos únicos hechos a mano.",
  ...
  en: {
    feat_title:"🏪 Featured Businesses in Pomaire", feat_sub:"The best recommended places for your visit", feat_loading:"Loading featured businesses...", feat_all:"See all businesses →",
    cat_title:"Discover Pomaire", cat_sub:"The must-sees of Chile's most famous pottery village", cat_loading:"Loading categories...",
    nav_games:"Games", lnk_intmap:"View on interactive map", sub_more:"More on Pomaire 360", sub_back:"Back to the full Pomaire 360 guide",
    apoyar_tag:"💛 Independent project · Made in Pomaire", apoyar_b1_t:"🔄 Always up to date", apoyar_b1_d:"Hours, contacts and details checked constantly.", apoyar_b2_t:"🚫 Ad-free", apoyar_b2_d:"A clean guide, with no ads or tracking.", apoyar_b3_t:"🤝 Local support", apoyar_b3_d:"We give visibility to the village's artisans and shops.", apoyar_other_t:"Other ways to support", apoyar_share:"📲 Share the guide", apoyar_follow:"📸 Follow us on Instagram",
    ch_winter_promo:"We'll be open during the winter break! · Monday to Sunday", ch_kicker:"🐷 A must-see attraction in Pomaire", ch_h1:"The world's largest clay piggy bank", ch_author:"Created by", ch_btn_hist:"See the Story", ch_btn_visit:"How to Visit", ch_share:"📤 Share", ch_role:"Master Potter · Pomaire, Chile", ch_bio:"A master potter from Pomaire and creator of the world's largest clay piggy bank. After a first pig in 2010, in 2012 he shaped a piece 1.60 m tall, 3 m long and weighing 550 kilos that is now an attraction of the town. With years of craft working Pomaire's clay, he turned an impossible idea into a unique work.", ch_howto:"🗺️ How to get there", ch_call:"📞 Call", ch_rec_title:"From a dream to a clay record", ch_rec_intro:"The piece that visitors see today wasn't made overnight: it was the result of two attempts, each one more ambitious than the last.", ch_rec1_t:"The first pig", ch_rec1_d:"In 2010 a pig-shaped clay piggy bank was created, <strong>0.4 meters tall</strong> and <strong>1.55 meters long</strong>, aiming to become a Guinness record for its size. The work was presented to the Pomaire community in an exhibition parade along the town's main tourist street.", ch_rec2_t:"The world's largest pig", ch_rec2_d:"In 2012, the artisan <strong>César Silva Rojo</strong> built a clay piggy bank <strong>1.60 meters tall by 3 meters long</strong> weighing <strong>550 kilos</strong>. This is the piece that tourists can visit today in his own workshop.", ch_rec2_s1:"<strong>1.60 m</strong> tall", ch_rec2_s2:"<strong>3 m</strong> long", ch_rec2_s3:"<strong>550 kg</strong> of clay", ch_hist_title:"The story of an impossible idea", ch_s1_t:"The idea", ch_s1_d:"It all starts with a dream: to create the world's largest clay piggy bank, taking Pomaire's tradition to a scale never seen before.", ch_s2_t:"The design", ch_s2_d:"Sketches and calculations to define the proportions, structure and strength of a giant clay piece.", ch_s3_t:"The modeling", ch_s3_d:"Handwork: shaping the clay with the technique inherited from generations of Pomaire potters.", ch_s4_t:"The drying", ch_s4_d:"Days of patience so the clay slowly loses moisture and avoids cracks in a work of this size.", ch_s5_t:"The firing", ch_s5_d:"The most delicate step: the kiln's fire hardens the clay and gives it its final terracotta color.", ch_s6_t:"The finished work", ch_s6_d:"The result: the world's largest clay piggy bank, the pride of Pomaire and an attraction for its visitors.", ch_visit_title:"How to visit", ch_seemap_btn:"📍 View on the interactive map", ch_addr:"Address: Los Paltos 323, Pomaire, Melipilla", ch_hours:"Hours: Saturday 12:00–18:00 · Sunday 12:00–19:30 · Mon–Fri closed", ch_phone:"Phone: +56 9 3356 6057",
    pl2_title:"San Antonio de Padua Church", pl3_title:"Kingdom Hall of Jehovah's Witnesses",
    he1_hours:"🕒 Hours: 8:29 to 17:29",
    sg_title:"Suggestions & feedback", sg_sub:"Found an error, have an idea or want to leave a comment? Help us improve the Pomaire guide. Your message goes straight to our email and WhatsApp.", sg_form_title:"📝 Send us your suggestion", sg_label_name:"Your name", sg_optional:"(optional)", sg_label_email:"Your email", sg_label_type:"Message type", sg_opt_general:"💡 General idea or suggestion", sg_opt_place:"📍 Fix details of a place", sg_opt_business:"🏪 Add a business or place", sg_opt_error:"🐞 Report a site bug", sg_opt_praise:"💛 Compliments", sg_opt_other:"✉️ Other", sg_label_msg:"Your message", sg_alert_msg:"Please write your message before sending.", sg_send_wa:"Send via WhatsApp", sg_send_mail:"Send by email", sg_note:"🔒 We don't share your data. We use your message only to reply and improve the guide.", sg_b1_t:"👂 We listen", sg_b1_d:"Every comment is reviewed by a real person on the project.", sg_b2_t:"🔄 Up-to-date info", sg_b2_d:"You help us fix opening hours, addresses and contacts.", sg_b3_t:"🤝 Built with the community", sg_b3_d:"Pomaire 360 improves thanks to those who visit and live in the town.", sg_ph_name:"E.g. Camila", sg_ph_email:"youremail@example.com", sg_ph_msg:"Write your comment or suggestion here...",
    eb_kicker:"🎉 What's happening in Pomaire", eb_title:"Upcoming events & festivities", eb_sub:"Fairs, festivals and celebrations of the pottery town. Tap an event to see all the details.", eb_go:"See details →", eb_all:"See the full events calendar →",
    eb_empanada_title:"Best Empanada of Pomaire Contest", eb_empanada_teaser:"Clay oven, a people's jury and the legendary giant empanadas. This Saturday — don't miss it!", eb_tag_food:"Food event", eb_flag_new:"New!", eb_flag_soon:"🔥 THIS SATURDAY!", eb_flag_done:"Finished", eb_flag_next:"Next week",
    eb_2_teaser:"Procession, cultural activities and special food in the square.", eb_3_teaser:"Food stalls, artisanal chicha, cueca dancing and festive crafts. The best time to visit!", eb_4_teaser:"Clay nativity scenes, ornaments and unique handmade gifts.",
    eb_greda_title:"Clay Festival", eb_greda_teaser:"Artisan demonstrations, clay sales and activities for the whole family.", eb_tag_greda:"Pottery tradition",
    ev_2_title:"San Antonio de Padua Feast", ev_3_title:"Chilean Independence Days", ev_4_title:"Christmas Craft Fair", ev_tag_fest:"Patron feast", ev_tag_nat:"Independence days", ev_tag_xmas:"Christmas",
    eb_mon_jun:"JUN", eb_mon_sep:"SEP", eb_mon_oct:"OCT", eb_mon_nov:"NOV", eb_mon_novdic:"NOV–DEC"
  },
  pt: {
    feat_title:"🏪 Negócios em Destaque de Pomaire", feat_sub:"Os melhores lugares recomendados para sua visita", feat_loading:"Carregando negócios em destaque...", feat_all:"Ver todos os negócios →",
    cat_title:"Descubra Pomaire", cat_sub:"Os imperdíveis do povoado dos oleiros mais famoso do Chile", cat_loading:"Carregando categorias...",
    nav_games:"Jogos", lnk_intmap:"Ver no mapa interativo", sub_more:"Mais em Pomaire 360", sub_back:"Voltar ao guia completo de Pomaire 360",
    apoyar_tag:"💛 Projeto independente · Feito em Pomaire", apoyar_b1_t:"🔄 Sempre atualizado", apoyar_b1_d:"Horários, contatos e dados revisados constantemente.", apoyar_b2_t:"🚫 Sem publicidade", apoyar_b2_d:"Um guia limpo, sem anúncios nem rastreamento.", apoyar_b3_t:"🤝 Apoio local", apoyar_b3_d:"Damos visibilidade aos artesãos e comércios do vilarejo.", apoyar_other_t:"Outras formas de apoiar", apoyar_share:"📲 Compartilhar o guia", apoyar_follow:"📸 Siga-nos no Instagram",
    ch_winter_promo:"Estaremos abertos nas férias de inverno! · Segunda a domingo", ch_kicker:"🐷 Atração imperdível de Pomaire", ch_h1:"O maior cofrinho de barro do mundo", ch_author:"Criado por", ch_btn_hist:"Ver História", ch_btn_visit:"Como Visitar", ch_share:"📤 Compartilhar", ch_role:"Mestre Oleiro · Pomaire, Chile", ch_bio:"Mestre oleiro de Pomaire e autor do maior cofrinho de barro do mundo. Após um primeiro porquinho em 2010, em 2012 moldou uma peça de 1,60 m de altura, 3 m de comprimento e 550 quilos de barro que hoje é atração do povoado. Com anos de ofício trabalhando o barro de Pomaire, transformou uma ideia impossível em uma obra única.", ch_howto:"🗺️ Como chegar", ch_call:"📞 Ligar", ch_rec_title:"De um sonho a um recorde de barro", ch_rec_intro:"A obra que os turistas visitam hoje não surgiu de um dia para o outro: foi o resultado de duas tentativas, cada uma mais ambiciosa que a anterior.", ch_rec1_t:"O primeiro porquinho", ch_rec1_d:"Em 2010 foi criado um cofrinho de barro em forma de porco de <strong>0,4 metros de altura</strong> e <strong>1,55 metros de comprimento</strong>, com a aspiração de se tornar recorde Guinness por seu tamanho. A obra foi apresentada à comunidade de Pomaire em um desfile de exibição pela principal via turística do povoado.", ch_rec2_t:"O maior porquinho do mundo", ch_rec2_d:"Em 2012, o artesão <strong>César Silva Rojo</strong> fabricou um cofrinho de barro de <strong>1,60 metros de altura por 3 metros de comprimento</strong> e peso de <strong>550 quilos</strong>. Esta é a peça que hoje pode ser visitada pelos turistas em sua própria oficina.", ch_rec2_s1:"<strong>1,60 m</strong> de altura", ch_rec2_s2:"<strong>3 m</strong> de comprimento", ch_rec2_s3:"<strong>550 kg</strong> de barro", ch_hist_title:"A história de uma ideia impossível", ch_s1_t:"A ideia", ch_s1_d:"Tudo começa com um sonho: criar o maior cofrinho de barro do mundo, levando a tradição de Pomaire a uma escala nunca vista.", ch_s2_t:"O design", ch_s2_d:"Esboços e cálculos para definir proporções, estrutura e resistência de uma peça gigante de barro.", ch_s3_t:"A modelagem", ch_s3_d:"O trabalho manual: moldar o barro com a técnica herdada de gerações de oleiros de Pomaire.", ch_s4_t:"A secagem", ch_s4_d:"Dias de paciência para que o barro perca umidade lentamente e evite rachaduras em uma obra deste tamanho.", ch_s5_t:"A queima", ch_s5_d:"O passo mais delicado: o fogo do forno endurece o barro e lhe dá sua cor terracota definitiva.", ch_s6_t:"A obra concluída", ch_s6_d:"O resultado: o maior cofrinho de barro do mundo, orgulho de Pomaire e atração para seus visitantes.", ch_visit_title:"Como visitar", ch_seemap_btn:"📍 Ver no mapa interativo", ch_addr:"Endereço: Los Paltos 323, Pomaire, Melipilla", ch_hours:"Horário: Sábado 12:00–18:00 · Domingo 12:00–19:30 · Seg–Sex fechado", ch_phone:"Telefone: +56 9 3356 6057",
    pl2_title:"Igreja Santo Antônio de Pádua", pl3_title:"Salão do Reino das Testemunhas de Jeová",
    he1_hours:"🕒 Horário: 8:29 às 17:29",
    sg_title:"Sugestões e comentários", sg_sub:"Encontrou um erro, tem uma ideia ou quer deixar um comentário? Ajude-nos a melhorar o guia de Pomaire. Sua mensagem chega direto ao nosso e-mail e WhatsApp.", sg_form_title:"📝 Conte sua sugestão", sg_label_name:"Seu nome", sg_optional:"(opcional)", sg_label_email:"Seu e-mail", sg_label_type:"Tipo de mensagem", sg_opt_general:"💡 Ideia ou sugestão geral", sg_opt_place:"📍 Corrigir dados de um lugar", sg_opt_business:"🏪 Adicionar um negócio ou lugar", sg_opt_error:"🐞 Reportar um erro do site", sg_opt_praise:"💛 Elogios", sg_opt_other:"✉️ Outro", sg_label_msg:"Sua mensagem", sg_alert_msg:"Por favor, escreva sua mensagem antes de enviar.", sg_send_wa:"Enviar pelo WhatsApp", sg_send_mail:"Enviar por e-mail", sg_note:"🔒 Não compartilhamos seus dados. Usamos sua mensagem apenas para responder e melhorar o guia.", sg_b1_t:"👂 Nós ouvimos", sg_b1_d:"Cada comentário é revisado por uma pessoa real do projeto.", sg_b2_t:"🔄 Dados atualizados", sg_b2_d:"Você nos ajuda a corrigir horários, endereços e contatos.", sg_b3_t:"🤝 Feito com a comunidade", sg_b3_d:"O Pomaire 360 melhora graças a quem visita e vive no povoado.", sg_ph_name:"Ex: Camila", sg_ph_email:"seuemail@exemplo.com", sg_ph_msg:"Escreva aqui seu comentário ou sugestão...",
    eb_kicker:"🎉 O que está rolando em Pomaire", eb_title:"Próximos eventos e festividades", eb_sub:"Feiras, festas e celebrações da vila oleira. Toque em um evento para ver todos os detalhes.", eb_go:"Ver detalhes →", eb_all:"Ver o calendário completo de eventos →",
    eb_empanada_title:"Concurso da Melhor Empanada de Pomaire", eb_empanada_teaser:"Forno de barro, júri popular e as lendárias empanadas gigantes. Neste sábado, não perca!", eb_tag_food:"Evento gastronômico", eb_flag_new:"Novo!", eb_flag_soon:"🔥 NESTE SÁBADO!", eb_flag_done:"Encerrado", eb_flag_next:"Próxima semana",
    eb_2_teaser:"Procissão, atividades culturais e gastronomia especial na praça.", eb_3_teaser:"Barracas, chicha artesanal, cueca e artesanato festivo. A melhor época!", eb_4_teaser:"Presépios em barro, enfeites e presentes únicos feitos à mão.",
    eb_greda_title:"Festa do Barro", eb_greda_teaser:"Demonstrações de artesãos, venda de peças e atividades para toda a família.", eb_tag_greda:"Tradição oleira",
    ev_2_title:"Festa de Santo Antônio de Pádua", ev_3_title:"Fiestas Patrias (Independência)", ev_4_title:"Feira de Artesanato de Natal", ev_tag_fest:"Festa padroeira", ev_tag_nat:"Fiestas Patrias", ev_tag_xmas:"Natal",
    eb_mon_jun:"JUN", eb_mon_sep:"SET", eb_mon_oct:"OUT", eb_mon_nov:"NOV", eb_mon_novdic:"NOV–DEZ"
  },
  ja: {
    feat_title:"🏪 ポマイレの注目のお店", feat_sub:"訪問におすすめの人気スポット", feat_loading:"注目のお店を読み込み中...", feat_all:"すべてのお店を見る →",
    cat_title:"ポマイレを発見", cat_sub:"チリで最も有名な陶工の村の外せないスポット", cat_loading:"カテゴリーを読み込み中...",
    nav_games:"ゲーム", lnk_intmap:"インタラクティブ地図で見る", sub_more:"ポマイレ360をもっと見る", sub_back:"ポマイレ360の完全ガイドに戻る",
    apoyar_tag:"💛 独立系プロジェクト · ポマイレ製", apoyar_b1_t:"🔄 常に最新", apoyar_b1_d:"営業時間・連絡先・情報を常に確認しています。", apoyar_b2_t:"🚫 広告なし", apoyar_b2_d:"広告も追跡もない、すっきりしたガイド。", apoyar_b3_t:"🤝 地域を応援", apoyar_b3_d:"村の職人やお店の露出を高めます。", apoyar_other_t:"その他の応援方法", apoyar_share:"📲 ガイドを共有", apoyar_follow:"📸 Instagramでフォロー",
    ch_winter_promo:"冬休み期間も営業します！ · 月〜日", ch_kicker:"🐷 ポマイレの外せない名所", ch_h1:"世界最大の陶器の貯金箱", ch_author:"制作者", ch_btn_hist:"物語を見る", ch_btn_visit:"見学方法", ch_share:"📤 共有", ch_role:"陶芸の巨匠 · チリ、ポマイレ", ch_bio:"ポマイレの陶芸の巨匠であり、世界最大の陶器の貯金箱の作者。2010年に最初の豚を作った後、2012年には高さ1.60メートル、長さ3メートル、重さ550キロの作品を仕上げ、今や村の名所となっています。長年ポマイレの粘土を扱ってきた技で、不可能と思われたアイデアを唯一無二の作品に変えました。", ch_howto:"🗺️ 行き方", ch_call:"📞 電話", ch_rec_title:"夢から粘土の記録へ", ch_rec_intro:"今日、観光客が訪れる作品は一日でできたものではありません。前回よりも野心的な2度の挑戦の結果です。", ch_rec1_t:"最初の豚", ch_rec1_d:"2010年、大きさでギネス記録を目指した豚の形の陶器の貯金箱が作られました。<strong>高さ0.4メートル</strong>、<strong>長さ1.55メートル</strong>。この作品は、村の主要な観光通りを巡る展示パレードでポマイレの人々にお披露目されました。", ch_rec2_t:"世界最大の豚", ch_rec2_d:"2012年、職人<strong>セサル・シルバ・ロホ</strong>が<strong>高さ1.60メートル、長さ3メートル</strong>、重さ<strong>550キロ</strong>の陶器の貯金箱を制作しました。これが、今日観光客が彼の工房で見学できる作品です。", ch_rec2_s1:"<strong>高さ1.60 m</strong>", ch_rec2_s2:"<strong>長さ3 m</strong>", ch_rec2_s3:"<strong>粘土550 kg</strong>", ch_hist_title:"不可能なアイデアの物語", ch_s1_t:"アイデア", ch_s1_d:"すべては夢から始まりました。世界最大の陶器の貯金箱を作り、ポマイレの伝統をかつてない規模へ。", ch_s2_t:"設計", ch_s2_d:"巨大な粘土作品の比率・構造・強度を決めるためのスケッチと計算。", ch_s3_t:"成形", ch_s3_d:"手作業：ポマイレの陶工が何世代も受け継いできた技法で粘土を形づくる。", ch_s4_t:"乾燥", ch_s4_d:"この大きさの作品にひびが入らないよう、粘土がゆっくり水分を抜くのを待つ、忍耐の日々。", ch_s5_t:"焼成", ch_s5_d:"最も繊細な工程：窯の火が粘土を硬くし、最終的なテラコッタ色を与える。", ch_s6_t:"完成した作品", ch_s6_d:"その結果が、世界最大の陶器の貯金箱。ポマイレの誇りであり、訪れる人々の名所です。", ch_visit_title:"見学方法", ch_seemap_btn:"📍 インタラクティブ地図で見る", ch_addr:"住所：Los Paltos 323, ポマイレ, メリピージャ", ch_hours:"営業時間：土曜 12:00–18:00 · 日曜 12:00–19:30 · 月〜金 休み", ch_phone:"電話：+56 9 3356 6057",
    pl2_title:"サン・アントニオ・デ・パドヴァ教会", pl3_title:"エホバの証人の王国会館",
    he1_hours:"🕒 営業時間：8:29〜17:29",
    sg_title:"ご意見・ご感想", sg_sub:"間違いを見つけた、アイデアがある、コメントを残したい？ポマイレのガイド改善にご協力ください。メッセージはメールとWhatsAppに直接届きます。", sg_form_title:"📝 ご提案をお聞かせください", sg_label_name:"お名前", sg_optional:"（任意）", sg_label_email:"メールアドレス", sg_label_type:"メッセージの種類", sg_opt_general:"💡 一般的なアイデア・提案", sg_opt_place:"📍 場所の情報を修正", sg_opt_business:"🏪 お店や場所を追加", sg_opt_error:"🐞 サイトの不具合を報告", sg_opt_praise:"💛 応援メッセージ", sg_opt_other:"✉️ その他", sg_label_msg:"メッセージ", sg_alert_msg:"送信する前にメッセージをご記入ください。", sg_send_wa:"WhatsAppで送信", sg_send_mail:"メールで送信", sg_note:"🔒 お客様のデータは共有しません。いただいたメッセージは返信とガイド改善のためだけに使用します。", sg_b1_t:"👂 耳を傾けます", sg_b1_d:"すべてのコメントはプロジェクトの実在するスタッフが確認します。", sg_b2_t:"🔄 最新の情報", sg_b2_d:"営業時間・住所・連絡先の修正にご協力いただけます。", sg_b3_t:"🤝 地域とともに", sg_b3_d:"ポマイレ360は、村を訪れ暮らす人々のおかげで良くなります。", sg_ph_name:"例：カミラ", sg_ph_email:"youremail@example.com", sg_ph_msg:"ここにコメントやご提案をご記入ください...",
    eb_kicker:"🎉 ポマイレの今", eb_title:"近日開催のイベント・お祭り", eb_sub:"陶芸の町の市・お祭り・催し。イベントをタップすると詳細が見られます。", eb_go:"詳細を見る →", eb_all:"イベントカレンダー全体を見る →",
    eb_empanada_title:"ポマイレ・ベストエンパナーダ・コンテスト", eb_empanada_teaser:"土窯焼き、来場者による審査、そして伝説の巨大エンパナーダ。今週土曜、お見逃しなく！", eb_tag_food:"グルメイベント", eb_flag_new:"新着！", eb_flag_soon:"🔥 今週の土曜！", eb_flag_done:"終了", eb_flag_next:"来週",
    eb_2_teaser:"行列、文化イベント、広場での特別グルメ。", eb_3_teaser:"屋台、自家製チチャ、クエカ、お祭りの工芸品。ベストシーズン！", eb_4_teaser:"陶器の降誕人形、飾り、手作りの特別な贈り物。",
    eb_greda_title:"陶器（グレダ）祭り", eb_greda_teaser:"職人の実演、陶器の販売、家族で楽しめる催し。", eb_tag_greda:"陶芸の伝統",
    ev_2_title:"サン・アントニオ・デ・パドヴァ祭", ev_3_title:"独立記念祭（フィエスタス・パトリアス）", ev_4_title:"クリスマス工芸市", ev_tag_fest:"守護聖人祭", ev_tag_nat:"独立記念祭", ev_tag_xmas:"クリスマス",
    eb_mon_jun:"6月", eb_mon_sep:"9月", eb_mon_oct:"10月", eb_mon_nov:"11月", eb_mon_novdic:"11〜12月"
  }
};
Object.keys(SUPPLEMENTAL_I18N).forEach(function(l){ if (LANGS[l]) Object.assign(LANGS[l], SUPPLEMENTAL_I18N[l]); });
