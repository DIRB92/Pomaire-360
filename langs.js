...
var SUPPLEMENTAL_I18N = {
  es: {
    ...
    eb_empanada_title:"Concurso de la Mejor Empanada de Pomaire", eb_empanada_teaser:"Horno de barro, jurado popular y las míticas empanadas gigantes. ¡Este sábado, no te lo pierdas!", eb_tag_food:"Evento gastronómico", eb_flag_new:"¡Nuevo!", eb_flag_soon:"🔥 ¡ESTE SÁBADO!",
  ...
  en: {
    ...
    eb_empanada_title:"Best Empanada of Pomaire Contest", eb_empanada_teaser:"Clay oven, a people's jury and the legendary giant empanadas. This Saturday — don't miss it!", eb_tag_food:"Food event", eb_flag_new:"New!", eb_flag_soon:"🔥 THIS SATURDAY!",
  ...
  pt: {
    ...
    eb_empanada_title:"Concurso da Melhor Empanada de Pomaire", eb_empanada_teaser:"Forno de barro, júri popular e as lendárias empanadas gigantes. Neste sábado, não perca!", eb_tag_food:"Evento gastronômico", eb_flag_new:"Novo!", eb_flag_soon:"🔥 NESTE SÁBADO!",
  ...
  ja: {
    ...
    eb_empanada_title:"ポマイレ・ベストエンパナーダ・コンテスト", eb_empanada_teaser:"土窯焼き、来場者による審査、そして伝説の巨大エンパナーダ。今週土曜、お見逃しなく！", eb_tag_food:"グルメイベント", eb_flag_new:"新着！", eb_flag_soon:"🔥 今週の土曜！",
