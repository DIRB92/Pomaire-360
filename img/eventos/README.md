...
- **Imagen principal:** `mejor-empanada-de-pomaire.webp` (afiche oficial, 1200×630, ~212 KB) — optimizada, se usa en la portada, redes sociales y datos estructurados. WhatsApp, Facebook y X ya renderizan WebP en previsualizaciones, por lo que se usa también como `og:image`.
- **Variante horizontal:** `mejor-empanada-de-pomaire-hrzt.webp` disponible para recortes apaisados.
- _(La antigua copia `.png` de 2,3 MB se eliminó por peso; el WebP la reemplaza en todos los usos.)_
